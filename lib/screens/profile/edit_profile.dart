...
class _EditProfileState extends State<EditProfile> {
          ...
          builder: (_, regProv, __) => Consumer<DataBridge>(
            builder: (_, dataBridge, __) => Container(
              ...
              child: Column(children: <Widget>[
                ...
                Column(
                  children: <Widget>[
                    dividerSection("General Information"),
                    ListTile(
                ...
                (widget.loginData.user.role.toLowerCase() == "groomer")
                    ? Column(
                        children: <Widget>[
                          dividerSection("Groomer Information"),
                          SwitchListTile(
                              ...
                              showModalBottomSheet(
                                  ...
                                  builder: (context) => ModalBottomArea(
                                        ...
                                        onSubmitPressed: (String data) {
                                          widget.loginData.user.coverageArea =
                                              data;
                                          dataBridge.setUserDataCopy(
                                              widget.loginData,
                                              notify: true);
                            ...
                            onTap: () {
                              ...
                              showModalBottomSheet(
                                  ...
                                  builder: (context) => ModalBottomSkill(
                                        ...
                                        regProv: regProv,
                                        onSubmitPressed: () {
                                          widget.loginData.user.styling =
                                              int.parse(regProv.getStyling
                                                  .toStringAsFixed(0));
                                          widget.loginData.user.clipping =
                                              int.parse(regProv.getCliping
                                                  .toStringAsFixed(0));
                                          widget.loginData.user
                                                  .yearsOfExperience =
                                              int.parse(
                                                  regProv.getYearExperience);
                    ...
                    onPressed: () {
                      reactiveModel.setState(
                        ...
                        Fluttertoast.showToast(
                            msg: "User Data Changed Successfull");

                        SharedPref _sharedPref = SharedPref();
                        _sharedPref.savingUserToLocal(
                            loginData:
                                json.encode(data.getLoginResponse.toJson()),
  ...
  Container dividerSection(String text) {
    return Container(
